function initMap() {
  ...
  document
    .getElementById("show-shelters")
    .addEventListener("click", showMarkers);
	document
		.getElementById("hide-shelters")
